...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/dsds/Documents/git/innsbruck-prototype/webpack-react-router-elemental-starter/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/dsds/Documents/git/innsbruck-prototype/webpack-react-router-elemental-starter/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _innsCard = __webpack_require__(157);

	var _innsCard2 = _interopRequireDefault(_innsCard);

	var _innsStickScrollList = __webpack_require__(171);

	var _innsStickScrollList2 = _interopRequireDefault(_innsStickScrollList);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(_innsStickScrollList2['default'], {
	        elements: [_react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(0);
	          }, index: 0 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(1);
	          }, index: 1 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(2);
	          }, index: 2 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(3);
	          }, index: 3 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(4);
	          }, index: 4 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(5);
	          }, index: 5 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(6);
	          }, index: 6 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(7);
	          }, index: 7 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(8);
	          }, index: 8 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(9);
	          }, index: 9 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(10);
	          }, index: 10 }), _react2['default'].createElement(_innsCard2['default'], { onMove: function (x, y) {
	            return _this.move(x, y);
	          }, onDown: function () {
	            return _this.down(11);
	          }, index: 11 })],
	        height: window.innerWidth / 2,
	        offset: [0, -200],
	        to: [this.state.x + this.state.dx, this.state.y + this.state.dy],
	        index: this.state.i });
	    }
	  }]);
	...
	var _default = (function (_React$Component) {
	  ...
	  function _default(props) {
	    ...
	    this.state = {
	      ...
	      x: 0,
	      y: 0,
	      bg: __webpack_require__(158)("./" + (props.index + 1) + '.jpg')
	    };
	  }
	  ...
	  _createClass(_default, [{
	    ...
	    value: function down(ev) {
	      ...
	      var pageX = _ev$touches$0.pageX;
	      var pageY = _ev$touches$0.pageY;
	    ...
	    key: 'up',
	    value: function up() {
	      this.setState({ hold: false, scale: false, moved: true });
	    }
	  }, {
	    key: 'move',
	    value: function move(ev) {
	      var _ev$touches$02 = ev.touches[0];
	      var pageX = _ev$touches$02.pageX;
	      var pageY = _ev$touches$02.pageY;

	      ev.preventDefault();

	      if (!this.state.moved) {
	        this.setState({ moved: true, scale: false });
	      }

	      if (this.props.onMove) {
	        this.props.onMove(pageX - this.state.x, pageY - this.state.y);
	      }
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (this.state.hold) {
	        styles.boxShadow = '0 4px 8px #000';
	        styles.transform = 'scale(1.1, 1.1)';
	      } else {
	        styles.boxShadow = '0 0 0 #000';
	        styles.transform = 'scale(1, 1)';
	      }

	      if (this.state.scale) {
	        var dx = this.props.index % 2 ? '-25%' : '25%';
	        styles.boxShadow = '0 8px 20px #000';
	        styles.transform = 'scale(2, 2) translate(' + dx + ', 0)';
	      }

	      styles.backgroundImage = 'url(' + this.state.bg + ')';
	      ...
	      return React.createElement(
	        'div',
	        {
	          ...
	          onTouchStart: function (ev) {
	            return _this2.down(ev);
	          },
	          onTouchEnd: function () {
	            return _this2.up();
	          },
	          onTouchMove: function (ev) {
	            return _this2.move(ev);
	          },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "b4619d6462e83256f2c48c1c25aab163.jpg";

/***/ },
/* 160 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "9adbe9064ff36a0c7e8c4c2ae701eff4.jpg";

/***/ },
/* 161 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "5ea6fd382bbd9b8d07e70dddafb16961.jpg";

/***/ },
/* 162 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "20d99661af0e86bc02dfb11f49a52679.jpg";

/***/ },
/* 163 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "e67ead262a3ab0558a1d829beacab08f.jpg";

/***/ },
/* 164 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "76ddc7ac64a8e172ccaf74c4487f2b4d.jpg";

/***/ },
/* 165 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "93e6d5892e9e91b3e6908cf28f862e3f.jpg";

/***/ },
/* 166 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "5c9fce6b70b1f60ad16e61907b8462f3.jpg";

/***/ },
/* 167 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "d6fbabc9a8ad41058c6c22380938518c.jpg";

/***/ },
/* 168 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "adfe832b2ae1b24e219f2ab2e61d142c.jpg";

/***/ },
/* 169 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "0c42b11c97e5780d974d66f93dd16a04.jpg";

/***/ },
/* 170 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "66fb9cc070f0298fef1079b91d3d913f.jpg";
	...
	var _default = (function (_React$Component) {
	  ...
	  _createClass(_default, [{
	    ...
	    value: function render() {
	      ...
	      var defaultStyles = this.props.elements.map(function () {
	        return { y: _this.props.offset[1] };
	      });
	      ...
	      return React.createElement(
	        _reactMotion.StaggeredMotion,
	        {
	          ...
	          styles: function (prevInterpolatedStyles) {
	            return prevInterpolatedStyles.map(function (_, i) {
	              var s = i == _this.props.index + 1 ? 150 : 300;
	              return i < _this.props.index ? { y: (0, _reactMotion.spring)(prevInterpolatedStyles[i + 1].y - _this.props.height, { damping: 30, stiffness: 300 }) } : i == _this.props.index ? { y: (0, _reactMotion.spring)(_this.props.to[1] + _this.props.height * i, { damping: 30, stiffness: 300 }), z: 1 } : { y: (0, _reactMotion.spring)(prevInterpolatedStyles[i - 1].y + _this.props.height, { damping: 20, stiffness: s }) };
	            });
	          } },
	        function (interpolatingStyles) {
	          return React.createElement(
	            ...
	            interpolatingStyles.map(function (style, i) {
	              var dx = i % 2 ? _this.props.height : 0;
	              var dy = ~ ~(i / 2 + 0.5) * _this.props.height;
	              return React.createElement(
	                'div',
	                {
	                  key: i,
	                  style: { position: 'absolute', transform: 'translate3D(' + dx + 'px, ' + (style.y - dy) + 'px, 0)', zIndex: style.z ? 1 : 0 } },
	                _this.props.elements[i]
	              );
	            })
	          );
	        }
